...
LIMIT 5;
  ...
  #PROFIT
  SELECT round((SALESAMOUNT - TOTALPRODUCTCOST - FREIGHT - TAXAMT),4) AS total_profit FROM ADSALES;
...
#no.of customers
    select count(customerkey)as customer_count from adcustomer;

#no.of products
select count(productkey) as product_count from adproduct;
